class Technical_Params:
    ...
    Performance_2 = [
        "ta_perf2",
        {
            ...
            "ytd50o": "YTD +50%",
            "ytd100o": "YTD +100%",
            # 3/5/10-year value codes extracted live from Finviz's `fs_ta_perf2`
            # <select> (screener.ashx?v=111&ft=4, 2026-08-11) — orchestrator change
            # request docs/pendingwork/2026-07-25-scrape-link-http-api.md (frozen
            # 9-filter screen uses `ta_perf2_3yup`). Continues the file's increasing-
            # duration ordering convention (day < week < ... < year < YTD < 3y < 5y < 10y).
            "3y90u": "3 Years -90%",
            "3y75u": "3 Years -75%",
            "3y50u": "3 Years -50%",
            "3y30u": "3 Years -30%",
    ...
    Tow_Hundreds_Day_Simple_Moving_Average = [
        "ta_sma200",
        {
            "": "Any",
    ...
    After_Hours_Close = ["ah_close", {"": "Any", "frange": "Custom (Elite only)"}]

    After_Hours_Change = ["ah_change", {"": "Any", "frange": "Custom (Elite only)"}]
